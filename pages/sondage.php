                ...
                <div class="survey-part" data-part="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            ...
                            <label class="radio-label"><input type="radio" name="annee" value="Master"> Master1</label>
                            <label class="radio-label"><input type="radio" name="annee" value="Master"> Master2</label>                                              <label class="radio-label"><input type="radio" name="annee" value="Autre"> Autre</label>
                            <label class="radio-label"><input type="radio" name="annee" value="Autre"> Autre</label>                                              <label class="radio-label"><input type="radio" name="annee" value="Autre"> Autre</label>
